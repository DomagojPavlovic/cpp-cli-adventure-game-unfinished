...
std::map<int, Line> ResourcesUI::getLines() {
    ...
    std::string firstLine { "HP: " + std::to_string(m_player->getCurrentHealth()) + '/' + std::to_string(m_player->getMaxHealth()) };
    std::string secondLine { "MP: " + std::to_string(m_player->getCurrentMana()) + '/' + std::to_string(m_player->getMaxMana()) };
    std::string thirdLine { "SP: " + std::to_string(m_player->getCurrentStamina()) + '/' + std::to_string(m_player->getMaxStamina()) };
